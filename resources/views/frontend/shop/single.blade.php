...
<img class="product__details__pic__item--large" src="{{ \App\Helper\Helper::image_url($product->image)}}">
                        </div>


<div class="product__details__pic__slider owl-carousel">
@forelse(\App\Image::where('products_id',$product->id)->get() as $product_image)
    <img data-imgbigurl="{{$product_image->image}}"
        src="{{\App\Helper\Helper::image_url($product_image->image)}}" alt="">
@empty
<p>No image found</p>
@endforelse
</div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <ul>
                            ...
                            <li><b>Brand</b> <span>{{$product->brands->name}}</span></li>
                            <li><b>Category</b> <span>{{$product->categories->name}}</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-12">
