<?php namespace App\Http\Controllers;
	...
	class AdminBlogs1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Permalink","name"=>"permalink"];
			...
			//$this->form[] = ["label"=>"Permalink","name"=>"permalink","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
        ...
        public function getAdd()
        {
        	...
        	$this->cbView('frontend.blog.blog',$data);
        }
